...
<div class="row">
    <div class="col-lg-12">
    	<h3><strong><i class="fa fa-wrench"></i> TECHNICIAN <small>View All</small></strong></h3>
    </div>
</div>
    	<hr>
<?php include('fmd-nav.php'); ?>
<?php if ($techician_tbl->Export == "" && $techician_tbl->CurrentAction == "") { ?>
<a href="javascript:ew_ToggleSearchPanel(techician_tbl_list);" style="text-decoration: none;"><img id="techician_tbl_list_SearchImage" src="images/collapse.gif" alt="" width="10" height="10" border="0"></a><span class="phpmaker">&nbsp;<?php echo $Language->Phrase("Search") ?></span><br>
...
<table class="ewBasicSearch" style="margin-left:50px">
	<tr>
		<td><span class="phpmaker">
			<input type="text" class="searchbox"  name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" size="20" value="<?php echo ew_HtmlEncode($techician_tbl->getSessionBasicSearchKeyword()) ?>">
			
			<input type="Submit" name="Submit"  class="btn btn-primary btn-sm" id="Submit" value="Search">

			<img src="img/system/buttons/export_excel.png" title="Export to Excel" onclick="javascript:location.href='<?php echo $techician_tbl_list->ExportExcelUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/csv.png" title="Export to CSV" onclick="javascript:location.href='<?php echo $techician_tbl_list->ExportCsvUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/showall.png" title="Show All" onclick="javascript:location.href='<?php echo $techician_tbl_list->PageUrl() ?>cmd=reset'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/advanced_search.png" title="Advanced Search" onclick="javascript:location.href='techician_tblsrch.php'" class='onhover cursorpointer' height='40px' width='auto'>
...
<?php if ($techician_tbl->strtechname->Visible) { // strtechname ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $techician_tbl->SortUrl($techician_tbl->strtechname) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"><?php echo "Technician Name"?></td><td style="width: 10px;"><?php if ($techician_tbl->strtechname->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($techician_tbl->strtechname->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($techician_tbl->strremarks->Visible) { // strremarks ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $techician_tbl->SortUrl($techician_tbl->strremarks) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"><?php echo "Remarks" ?></td><td style="width: 10px;"><?php if ($techician_tbl->strremarks->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($techician_tbl->strremarks->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<img src="img/system/buttons/assign_technician.png" title="Add New" onclick="javascript:location.href='<?php echo $techician_tbl_list->AddUrl ?>'" class='onhover cursorpointer' height='35px' width='auto'>
<?php if ($techician_tbl_list->lTotalRecs > 0) { ?>
<a href="" onclick="ew_SubmitSelected(document.ftechician_tbllist, '<?php echo $techician_tbl_list->MultiDeleteUrl ?>');return false;"><img src="img/system/buttons/delete.png" title="Delete Record" class='onhover cursorpointer' height='40px' width='auto'></a>
<?php } ?>
