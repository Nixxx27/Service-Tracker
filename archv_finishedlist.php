...
<div class="row">
	<?php
    		// all
    		$query = "SELECT COUNT(*) AS total FROM archv_finished";
    		...
    		?>
    		<div class="col-lg-12">
    			<h3><strong><i class="fa fa-cog fa-spin"></i> FINISHED JOBS <small>Archived</small> <span class="badge" title="Total Records">&nbsp;<?php echo $num_total; ?>&nbsp;</span></strong></h3>
    		</div>
    	</div>
    	<hr>
	...
	<table class="ewBasicSearch" style="margin-left:50px">
		<tr>
			<td><span class="phpmaker">
				<input type="text" class="searchbox" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" size="20" value="<?php echo ew_HtmlEncode($archv_finished->getSessionBasicSearchKeyword()) ?>">
				<input type="Submit" name="Submit"  class="btn btn-primary btn-sm" id="Submit" value="Search">
				<img src="img/system/buttons/export_excel.png" title="Export to Excel" onclick="javascript:location.href='<?php echo $archv_finished_list->ExportExcelUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
				<img src="img/system/buttons/csv.png" title="Export to CSV" onclick="javascript:location.href='<?php echo $archv_finished_list->ExportCsvUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
				<img src="img/system/buttons/showall.png" title="Show All" onclick="javascript:location.href='<?php echo $archv_finished_list->PageUrl() ?>cmd=reset'" class='onhover cursorpointer' height='40px' width='auto'>
				<img src="img/system/buttons/advanced_search.png" title="Advanced Search" onclick="javascript:location.href='archv_finishedsrch.php'" class='onhover cursorpointer' height='40px' width='auto'>
				<img src='img/system/buttons/with_pr.png' onclick="javascript:location.href='archv_finishedlist.php?x_strwithpr=1&z_strwithpr=LIKE'" class='onhover cursorpointer' height='35px' width='auto' title='View JO with PR'>
			</td>
...
<?php if ($archv_finished->strjrfnum->Visible) { // strjrfnum ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strjrfnum) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo  "JRF/SC#" ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strjrfnum->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strjrfnum->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($archv_finished->strdate->Visible) { // strdate ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strdate) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo "DATE RECEIVED" ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strdate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strdate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>	
...
<?php if ($archv_finished->strduedate->Visible) { // strduedate ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strduedate) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo "DUE DATE" ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strduedate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strduedate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>	
...
<?php if ($archv_finished->strsubject->Visible) { // strsubject ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strsubject) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo " SUBJECT " ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strsubject->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strsubject->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>			
...
<?php if ($archv_finished->strusername->Visible) { // strusername ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strusername) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo "REQUESTED BY" ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strusername->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strusername->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($archv_finished->strdepartment->Visible) { // strdepartment ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strdepartment) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo "DEPARTMENT" ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strdepartment->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strdepartment->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($archv_finished->strnature->Visible) { // strnature ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strnature) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo "NATURE" ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strnature->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strnature->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($archv_finished->strpriority->Visible) { // strpriority ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strpriority) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"><?php echo "PRIORITY" ?></td><td style="width: 10px;"><?php if ($archv_finished->strpriority->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strpriority->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($archv_finished->strcategory->Visible) { // strcategory ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strcategory) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td>&nbsp;<?php echo "SECTION" ?>&nbsp;</td><td style="width: 10px;"><?php if ($archv_finished->strcategory->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strcategory->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($archv_finished->work_days->Visible) { // work_days ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->work_days) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "NO. OF DAYS" ?></td><td style="width: 10px;"><?php if ($archv_finished->work_days->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->work_days->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>	
...
<?php if ($archv_finished->strwithpr->Visible) { // strwithpr ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $archv_finished->SortUrl($archv_finished->strwithpr) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "PR"; ?></td><td style="width: 10px;"><?php if ($archv_finished->strwithpr->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($archv_finished->strwithpr->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>			
<?php
...
<?php if ($archv_finished->strdate->Visible) { // strdate ?>
		<td bgcolor='#449d44'>
<div<?php echo $archv_finished->strdate->ViewAttributes() ?>>
	<?php

		$orig_received_date = $archv_finished->strdate->ListViewValue() ;
	  ...
	  switch ($the_month_received) {
		...
		echo str_replace("/"," ",$convert_month_received). " " .$archv_finished->strtime->ListViewValue(); 
	?>
...
<?php if ($archv_finished->strdatecomplete->Visible) { // strdatecomplete ?>
		<td bgcolor='#449d44'>
<div<?php echo $archv_finished->strdatecomplete->ViewAttributes() ?>>
<?php 

	 $orig_completed =  $archv_finished->strdatecomplete->ListViewValue() ;
	  $the_month =substr($orig_completed, 0, 2); //01,02
	  ...
	  switch ($the_month) {
		...
		$convert_month = $the_month.substr($orig_completed, 2, 14);
...
<?php if ($archv_finished->strduedate->Visible) { // strduedate ?>
		<td bgcolor='#449d44'>
<div<?php echo $archv_finished->strduedate->ViewAttributes() ?>>
	<?php
		$orig_due =  $archv_finished->strduedate->ListViewValue()  ;
	  $the_month =substr($orig_due, 0, 2); //01,02
	  ...
	  switch ($the_month) {
		...
		$convert_month = $the_month.substr($orig_due, 2, 14);
		 echo str_replace("/"," ",$convert_month);
	?>
</div>
</td>
...
<?php if ($archv_finished->strsubject->Visible) { // strsubject ?>
		<td bgcolor='#449d44'>
<div<?php echo $archv_finished->strsubject->ViewAttributes() ?>><?php echo ucfirst(strtolower($archv_finished->strsubject->ListViewValue())); ?></div>
</td>
	<?php } ?>
...
<?php if ($archv_finished->work_days->Visible) { // work_days ?>
		<td bgcolor='#449d44' align="center">
<div<?php echo $archv_finished->work_days->ViewAttributes() ?>><?php echo $archv_finished->work_days->ListViewValue() ?></div>
</td>
	<?php } ?>
<?php if ($archv_finished->strwithpr->Visible) { // strwithpr ?>
		<td bgcolor='#449d44'>
<div<?php echo $archv_finished->strwithpr->ViewAttributes() ?>>
	<?php 
		$with_pr = $archv_finished->strwithpr->ListViewValue() ;
