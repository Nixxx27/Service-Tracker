...
<input type="text" name="x_strnature" id="x_strnature" required title="<?php echo $nature_tbl->strnature->FldTitle() ?>" size="30" maxlength="200" value="<?php echo $nature_tbl->strnature->EditValue ?>"<?php echo $nature_tbl->strnature->EditAttributes() ?>>
