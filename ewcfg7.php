...
define("EW_PROJECT_NAME", "service_tracker", TRUE); // Project name
define("EW_RANDOM_KEY", 'tpBVQejoXk2f565v', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "service_tracker.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_PASS", "nikkoz06", TRUE);
define("EW_CONN_DB", "sts", TRUE);
