...
<div class="row">
    		<div class="col-lg-12">
    			<h3><strong><i class="fa fa-wrench"></i> JOB REQUEST <small>View All Records</small></strong></h3>
    		</div>
    	</div>
    	<hr>
...
<?php if ($jrf_tbl->ID->Visible) { // ID ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->ID) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "ID" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->ID->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->ID->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strjrfnum->Visible) { // strjrfnum ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strjrfnum) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo  "JRF/SC#" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strjrfnum->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strjrfnum->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strdate->Visible) { // strdate ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strdate) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "DATE RECEIVED" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strdate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strdate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strduedate->Visible) { // strduedate ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strduedate) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td> <?php echo "DUE DATE" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strduedate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strduedate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strsubject->Visible) { // strsubject ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strsubject) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "SUBJECT" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strsubject->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strsubject->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strusername->Visible) { // strusername ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strusername) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "REQUESTED BY" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strusername->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strusername->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strdepartment->Visible) { // strdepartment ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strdepartment) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "DEPARTMENT" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strdepartment->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strdepartment->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strnature->Visible) { // strnature ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strnature) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "NATURE OF CALL" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strnature->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strnature->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($jrf_tbl->strstatus->Visible) { // strstatus ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strstatus) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "STATUS" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strstatus->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strstatus->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>

	<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strduedate) ?>',1);"> <!--Over Due -->
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo "OVER DUE" ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strduedate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strduedate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
	</div></td>	
<?php } ?>		
<?php
...
/*  ============= UPDATE  =============== */
	...
	$_ID =  $jrf_tbl->ID->ListViewValue();
	
	$pr_img_icon_array = array($_ID);
	foreach ($pr_img_icon_array as $value) {
   			"$value <br>";
...
/*  ============= UPDATE =============== */
	...
	if ($strstatus == "Finished" || $strstatus == "Cancelled") {
		$color = "bgcolor='#449d44'";
		$warning_icon = "";
		$stroverdue_num = 0;
	}else{
		...
		if($total_overdue_num<=0){
			...
			$warning_icon = "";
				...
				$stroverdue_num = 0;
					...
					$overdue_ID=  $jrf_tbl->ID->ListViewValue();
					$overde_id_array = array($overdue_ID);
					$update_overdue = new UpdateClass();
					foreach ($overde_id_array as $value) {
   					 "$value <br>";
   					$val = " ";
	   				$update_overdue->updateOverDue($value,$val);
	   				}
				}else{
			...
			$warning_icon = "<img src='img/system/buttons/warning.gif' width=18px height=17px title='Request is Over Due!'>";
			};
	} // else


	//After Search
	if(isset($_GET['x_strstatus'])){
			$get_status = $_GET['x_strstatus'];
			if($get_status=="finished" || $get_status=="cancelled"){
				$color = "bgcolor='#449d44'";
				$warning_icon = "";
				$stroverdue_num = "";
...
<div<?php echo $jrf_tbl->strjrfnum->ViewAttributes() ?>><?php echo $jrf_tbl->strjrfnum->ListViewValue() ?></div>
	...
	<?php if ($jrf_tbl->strdate->Visible) { // strdate ?>
		<td <?php echo $color; ?>>
<div<?php echo $jrf_tbl->strdate->ViewAttributes() ?>><?php echo $jrf_tbl->strdate->ListViewValue(). " " . $jrf_tbl->strtime->ListViewValue();  ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strduedate->Visible) { // strduedate ?>
		<td <?php echo $color; ?>>
<div<?php echo $jrf_tbl->strduedate->ViewAttributes() ?>><?php echo $jrf_tbl->strduedate->ListViewValue() ?></div>
	...
	<?php if ($jrf_tbl->strsubject->Visible) { // strsubject ?>
		<td <?php echo $color; ?>>
<div<?php echo $jrf_tbl->strsubject->ViewAttributes() ?>><?php echo ucfirst(strtolower($jrf_tbl->strsubject->ListViewValue())); ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strusername->Visible) { // strusername ?>
		<td <?php echo $color; ?>>
...
<div<?php echo $jrf_tbl->strstatus->ViewAttributes() ?>><?php echo $jrf_tbl->strstatus->ListViewValue() ?></div>
	...
	<?php } ?>
		<?php if ($jrf_tbl->strduedate->Visible) { // Over due Date ?>
	<td <?php echo $color; ?> align="center" >
<div><?php echo $warning_icon . " " . $stroverdue_num;?></div>
</td>
	<?php } ?>
<?php
