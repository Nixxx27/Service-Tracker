...
//
// Table class for jrf_tbl
//
class cjrf_tbl {
	var $TableVar = 'jrf_tbl';
	...
	function cjrf_tbl() {
		...
		// ID
		$this->ID = new cField('jrf_tbl', 'jrf_tbl', 'x_ID', 'ID', '`ID`', 3, -1, FALSE, '`ID`', FALSE);
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] =& $this->ID;

		// strjrfnum
		$this->strjrfnum = new cField('jrf_tbl', 'jrf_tbl', 'x_strjrfnum', 'strjrfnum', '`strjrfnum`', 200, -1, FALSE, '`strjrfnum`', FALSE);
		$this->fields['strjrfnum'] =& $this->strjrfnum;

		// strquarter
		$this->strquarter = new cField('jrf_tbl', 'jrf_tbl', 'x_strquarter', 'strquarter', '`strquarter`', 200, -1, FALSE, '`strquarter`', FALSE);
		$this->fields['strquarter'] =& $this->strquarter;

		// strmon
		$this->strmon = new cField('jrf_tbl', 'jrf_tbl', 'x_strmon', 'strmon', '`strmon`', 200, -1, FALSE, '`strmon`', FALSE);
		$this->strmon->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['strmon'] =& $this->strmon;

		// stryear
		$this->stryear = new cField('jrf_tbl', 'jrf_tbl', 'x_stryear', 'stryear', '`stryear`', 200, -1, FALSE, '`stryear`', FALSE);
		$this->fields['stryear'] =& $this->stryear;

		// strdate
		$this->strdate = new cField('jrf_tbl', 'jrf_tbl', 'x_strdate', 'strdate', '`strdate`', 200, -1, FALSE, '`strdate`', FALSE);
		$this->fields['strdate'] =& $this->strdate;

		// strtime
		$this->strtime = new cField('jrf_tbl', 'jrf_tbl', 'x_strtime', 'strtime', '`strtime`', 200, -1, FALSE, '`strtime`', FALSE);
		$this->fields['strtime'] =& $this->strtime;

		// strduedate
		$this->strduedate = new cField('jrf_tbl', 'jrf_tbl', 'x_strduedate', 'strduedate', '`strduedate`', 200, -1, FALSE, '`strduedate`', FALSE);
		$this->fields['strduedate'] =& $this->strduedate;

		// strsubject
		$this->strsubject = new cField('jrf_tbl', 'jrf_tbl', 'x_strsubject', 'strsubject', '`strsubject`', 201, -1, FALSE, '`strsubject`', FALSE);
		$this->fields['strsubject'] =& $this->strsubject;

		// strusername
		$this->strusername = new cField('jrf_tbl', 'jrf_tbl', 'x_strusername', 'strusername', '`strusername`', 200, -1, FALSE, '`strusername`', FALSE);
		$this->fields['strusername'] =& $this->strusername;

		// strusereadd
		$this->strusereadd = new cField('jrf_tbl', 'jrf_tbl', 'x_strusereadd', 'strusereadd', '`strusereadd`', 200, -1, FALSE, '`strusereadd`', FALSE);
		$this->fields['strusereadd'] =& $this->strusereadd;

		// strcompany
		$this->strcompany = new cField('jrf_tbl', 'jrf_tbl', 'x_strcompany', 'strcompany', '`strcompany`', 200, -1, FALSE, '`strcompany`', FALSE);
		$this->fields['strcompany'] =& $this->strcompany;

		// strdepartment
		$this->strdepartment = new cField('jrf_tbl', 'jrf_tbl', 'x_strdepartment', 'strdepartment', '`strdepartment`', 200, -1, FALSE, '`strdepartment`', FALSE);
		$this->fields['strdepartment'] =& $this->strdepartment;

		// strloc
		$this->strloc = new cField('jrf_tbl', 'jrf_tbl', 'x_strloc', 'strloc', '`strloc`', 200, -1, FALSE, '`strloc`', FALSE);
		$this->fields['strloc'] =& $this->strloc;

		// strposition
		$this->strposition = new cField('jrf_tbl', 'jrf_tbl', 'x_strposition', 'strposition', '`strposition`', 200, -1, FALSE, '`strposition`', FALSE);
		$this->fields['strposition'] =& $this->strposition;

		// strtelephone
		$this->strtelephone = new cField('jrf_tbl', 'jrf_tbl', 'x_strtelephone', 'strtelephone', '`strtelephone`', 200, -1, FALSE, '`strtelephone`', FALSE);
		$this->fields['strtelephone'] =& $this->strtelephone;

		// strcostcent
		$this->strcostcent = new cField('jrf_tbl', 'jrf_tbl', 'x_strcostcent', 'strcostcent', '`strcostcent`', 200, -1, FALSE, '`strcostcent`', FALSE);
		$this->fields['strcostcent'] =& $this->strcostcent;

		// strnature
		$this->strnature = new cField('jrf_tbl', 'jrf_tbl', 'x_strnature', 'strnature', '`strnature`', 200, -1, FALSE, '`strnature`', FALSE);
		$this->fields['strnature'] =& $this->strnature;

		// strdescript
		$this->strdescript = new cField('jrf_tbl', 'jrf_tbl', 'x_strdescript', 'strdescript', '`strdescript`', 201, -1, FALSE, '`strdescript`', FALSE);
		$this->fields['strdescript'] =& $this->strdescript;

		// strattach
		$this->strattach = new cField('jrf_tbl', 'jrf_tbl', 'x_strattach', 'strattach', '`strattach`', 200, -1, FALSE, '`strattach`', FALSE);
		$this->fields['strattach'] =& $this->strattach;

		// strarea
		$this->strarea = new cField('jrf_tbl', 'jrf_tbl', 'x_strarea', 'strarea', '`strarea`', 200, -1, FALSE, '`strarea`', FALSE);
		$this->fields['strarea'] =& $this->strarea;

		// strpriority
		$this->strpriority = new cField('jrf_tbl', 'jrf_tbl', 'x_strpriority', 'strpriority', '`strpriority`', 200, -1, FALSE, '`strpriority`', FALSE);
		$this->fields['strpriority'] =& $this->strpriority;

		// strstatus
		$this->strstatus = new cField('jrf_tbl', 'jrf_tbl', 'x_strstatus', 'strstatus', '`strstatus`', 200, -1, FALSE, '`strstatus`', FALSE);
		$this->fields['strstatus'] =& $this->strstatus;

		// strlastedit
		$this->strlastedit = new cField('jrf_tbl', 'jrf_tbl', 'x_strlastedit', 'strlastedit', '`strlastedit`', 200, -1, FALSE, '`strlastedit`', FALSE);
		$this->fields['strlastedit'] =& $this->strlastedit;

		// strcategory
		$this->strcategory = new cField('jrf_tbl', 'jrf_tbl', 'x_strcategory', 'strcategory', '`strcategory`', 200, -1, FALSE, '`strcategory`', FALSE);
		$this->fields['strcategory'] =& $this->strcategory;

		// strassigned
		$this->strassigned = new cField('jrf_tbl', 'jrf_tbl', 'x_strassigned', 'strassigned', '`strassigned`', 200, -1, FALSE, '`strassigned`', FALSE);
		$this->fields['strassigned'] =& $this->strassigned;

		// strremarks
		$this->strremarks = new cField('jrf_tbl', 'jrf_tbl', 'x_strremarks', 'strremarks', '`strremarks`', 201, -1, FALSE, '`strremarks`', FALSE);
		$this->fields['strremarks'] =& $this->strremarks;

		// strdatecomplete
		$this->strdatecomplete = new cField('jrf_tbl', 'jrf_tbl', 'x_strdatecomplete', 'strdatecomplete', '`strdatecomplete`', 200, -1, FALSE, '`strdatecomplete`', FALSE);
		$this->fields['strdatecomplete'] =& $this->strdatecomplete;

		// strifoverdue
		$this->strifoverdue = new cField('jrf_tbl', 'jrf_tbl', 'x_strifoverdue', 'strifoverdue', '`strifoverdue`', 200, -1, FALSE, '`strifoverdue`', FALSE);
		$this->fields['strifoverdue'] =& $this->strifoverdue;

		// strwithpr
		$this->strwithpr = new cField('jrf_tbl', 'jrf_tbl', 'x_strwithpr', 'strwithpr', '`strwithpr`', 200, -1, FALSE, '`strwithpr`', FALSE);
		$this->fields['strwithpr'] =& $this->strwithpr;

		// sap_num
		$this->sap_num = new cField('jrf_tbl', 'jrf_tbl', 'x_sap_num', 'sap_num', '`sap_num`', 200, -1, FALSE, '`sap_num`', FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `jrf_tbl` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `jrf_tbl` SET ";
		foreach ($rs as $name => $value) {
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("jrf_tblview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "jrf_tbladd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("jrf_tbledit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("jrf_tbladd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("jrf_tbldelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=jrf_tbl" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->strifoverdue->setDbValue($rs->fields('strifoverdue'));
   ...
   // Common render codes
		...
		// strifoverdue
		$this->strifoverdue->CellCssStyle = ""; $this->strifoverdue->CellCssClass = "";
		$this->strifoverdue->CellAttrs = array(); $this->strifoverdue->ViewAttrs = array(); $this->strifoverdue->EditAttrs = array();
		...
		// strifoverdue
		$this->strifoverdue->ViewValue = $this->strifoverdue->CurrentValue;
		$this->strifoverdue->CssStyle = "";
		$this->strifoverdue->CssClass = "";
		$this->strifoverdue->ViewCustomAttributes = "";
		...
		// strifoverdue
		$this->strifoverdue->HrefValue = "";
		$this->strifoverdue->TooltipValue = "";
