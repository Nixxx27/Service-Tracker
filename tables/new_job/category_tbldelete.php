...
?>
<p><span class="phpmaker"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $category_tbl->TableCaption() ?><br><br>
<a href="<?php echo $category_tbl->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></span></p>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
...
<?php echo $category_tbl->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		...
		<td valign="top"><?php echo $category_tbl->strcategory->FldCaption() ?></td>
		<td valign="top"><?php echo $category_tbl->strremarks->FldCaption() ?></td>
	</tr>
	</thead>
	<tbody>
<?php
