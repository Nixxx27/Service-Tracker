...
?>
<p><span class="phpmaker" style="white-space: nowrap;"><?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $jrf_tbl->TableCaption() ?>
<?php if ($jrf_tbl->Export == "" && $jrf_tbl->CurrentAction == "") { ?>
&nbsp;&nbsp;<a href="<?php echo $jrf_tbl_list->ExportExcelUrl ?>"><?php echo $Language->Phrase("ExportToExcel") ?></a>
&nbsp;&nbsp;<a href="<?php echo $jrf_tbl_list->ExportCsvUrl ?>"><?php echo $Language->Phrase("ExportToCsv") ?></a>
<?php } ?>
</span></p>
<?php if ($jrf_tbl->Export == "" && $jrf_tbl->CurrentAction == "") { ?>
<a href="javascript:ew_ToggleSearchPanel(jrf_tbl_list);" style="text-decoration: none;"><img id="jrf_tbl_list_SearchImage" src="images/collapse.gif" alt="" width="9" height="9" border="0"></a><span class="phpmaker">&nbsp;<?php echo $Language->Phrase("Search") ?></span><br>
...
<table class="ewBasicSearch">
	<tr>
		<td><span class="phpmaker">
			<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" size="20" value="<?php echo ew_HtmlEncode($jrf_tbl->getSessionBasicSearchKeyword()) ?>">
			<input type="Submit" name="Submit" id="Submit" value="<?php echo ew_BtnCaption($Language->Phrase("QuickSearchBtn")) ?>">&nbsp;
			<a href="<?php echo $jrf_tbl_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>&nbsp;
			<a href="jrf_tblsrch.php"><?php echo $Language->Phrase("AdvancedSearch") ?></a>&nbsp;
...
<?php if ($jrf_tbl->strjrfnum->Visible) { // strjrfnum ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strjrfnum) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strjrfnum->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strjrfnum->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strjrfnum->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strquarter->Visible) { // strquarter ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strquarter) == "") { ?>
		<td><?php echo $jrf_tbl->strquarter->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strquarter) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strquarter->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strquarter->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strquarter->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strmon->Visible) { // strmon ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strmon) == "") { ?>
		<td><?php echo $jrf_tbl->strmon->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strmon) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strmon->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strmon->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strmon->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->stryear->Visible) { // stryear ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->stryear) == "") { ?>
		<td><?php echo $jrf_tbl->stryear->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->stryear) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->stryear->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->stryear->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->stryear->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strdate->Visible) { // strdate ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strdate) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strdate->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strdate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strdate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strtime->Visible) { // strtime ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strtime) == "") { ?>
		<td><?php echo $jrf_tbl->strtime->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strtime) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strtime->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strtime->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strtime->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strduedate->Visible) { // strduedate ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strduedate) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strduedate->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strduedate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strduedate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strsubject->Visible) { // strsubject ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strsubject) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strsubject->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strsubject->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strsubject->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strusername->Visible) { // strusername ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strusername) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strusername->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strusername->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strusername->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strusereadd->Visible) { // strusereadd ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strusereadd) == "") { ?>
		<td><?php echo $jrf_tbl->strusereadd->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strusereadd) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strusereadd->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strusereadd->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strusereadd->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strcompany->Visible) { // strcompany ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strcompany) == "") { ?>
		<td><?php echo $jrf_tbl->strcompany->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strcompany) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strcompany->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strcompany->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strcompany->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strdepartment->Visible) { // strdepartment ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strdepartment) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strdepartment->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strdepartment->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strdepartment->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strloc->Visible) { // strloc ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strloc) == "") { ?>
		<td><?php echo $jrf_tbl->strloc->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strloc) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strloc->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strloc->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strloc->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strposition->Visible) { // strposition ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strposition) == "") { ?>
		<td><?php echo $jrf_tbl->strposition->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strposition) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strposition->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strposition->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strposition->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strtelephone->Visible) { // strtelephone ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strtelephone) == "") { ?>
		<td><?php echo $jrf_tbl->strtelephone->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strtelephone) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strtelephone->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strtelephone->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strtelephone->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strcostcent->Visible) { // strcostcent ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strcostcent) == "") { ?>
		<td><?php echo $jrf_tbl->strcostcent->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strcostcent) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strcostcent->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strcostcent->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strcostcent->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strnature->Visible) { // strnature ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strnature) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strnature->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strnature->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strnature->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strdescript->Visible) { // strdescript ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strdescript) == "") { ?>
		<td><?php echo $jrf_tbl->strdescript->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strdescript) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strdescript->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strdescript->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strdescript->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strattach->Visible) { // strattach ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strattach) == "") { ?>
		<td><?php echo $jrf_tbl->strattach->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strattach) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strattach->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strattach->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strattach->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strarea->Visible) { // strarea ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strarea) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strarea->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strarea->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strarea->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strpriority->Visible) { // strpriority ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strpriority) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strpriority->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strpriority->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strpriority->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strstatus->Visible) { // strstatus ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strstatus) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strstatus->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strstatus->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strstatus->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strlastedit->Visible) { // strlastedit ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strlastedit) == "") { ?>
		<td><?php echo $jrf_tbl->strlastedit->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strlastedit) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strlastedit->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strlastedit->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strlastedit->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strcategory->Visible) { // strcategory ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strcategory) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strcategory->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strcategory->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strcategory->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strassigned->Visible) { // strassigned ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strassigned) == "") { ?>
		<td><?php echo $jrf_tbl->strassigned->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strassigned) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strassigned->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strassigned->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strassigned->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strremarks->Visible) { // strremarks ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strremarks) == "") { ?>
		<td><?php echo $jrf_tbl->strremarks->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strremarks) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strremarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strremarks->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strremarks->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strdatecomplete->Visible) { // strdatecomplete ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->strdatecomplete) == "") { ?>
		<td><?php echo $jrf_tbl->strdatecomplete->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strdatecomplete) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strdatecomplete->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strdatecomplete->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strdatecomplete->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strifoverdue->Visible) { // strifoverdue ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strifoverdue) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strifoverdue->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strifoverdue->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strifoverdue->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->strwithpr->Visible) { // strwithpr ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->strwithpr) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->strwithpr->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->strwithpr->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->strwithpr->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($jrf_tbl->sap_num->Visible) { // sap_num ?>
	<?php if ($jrf_tbl->SortUrl($jrf_tbl->sap_num) == "") { ?>
		<td><?php echo $jrf_tbl->sap_num->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $jrf_tbl->SortUrl($jrf_tbl->sap_num) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><?php echo $jrf_tbl->sap_num->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($jrf_tbl->sap_num->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($jrf_tbl->sap_num->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<div<?php echo $jrf_tbl->strquarter->ViewAttributes() ?>><?php echo $jrf_tbl->strquarter->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strmon->Visible) { // strmon ?>
		<td<?php echo $jrf_tbl->strmon->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strmon->ViewAttributes() ?>><?php echo $jrf_tbl->strmon->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->stryear->Visible) { // stryear ?>
		<td<?php echo $jrf_tbl->stryear->CellAttributes() ?>>
<div<?php echo $jrf_tbl->stryear->ViewAttributes() ?>><?php echo $jrf_tbl->stryear->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strdate->Visible) { // strdate ?>
		<td<?php echo $jrf_tbl->strdate->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strdate->ViewAttributes() ?>><?php echo $jrf_tbl->strdate->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strtime->Visible) { // strtime ?>
		<td<?php echo $jrf_tbl->strtime->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strtime->ViewAttributes() ?>><?php echo $jrf_tbl->strtime->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strduedate->Visible) { // strduedate ?>
		<td<?php echo $jrf_tbl->strduedate->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strduedate->ViewAttributes() ?>><?php echo $jrf_tbl->strduedate->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strsubject->Visible) { // strsubject ?>
		<td<?php echo $jrf_tbl->strsubject->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strsubject->ViewAttributes() ?>><?php echo $jrf_tbl->strsubject->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strusername->Visible) { // strusername ?>
...
<div<?php echo $jrf_tbl->strusereadd->ViewAttributes() ?>><?php echo $jrf_tbl->strusereadd->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strcompany->Visible) { // strcompany ?>
		<td<?php echo $jrf_tbl->strcompany->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strcompany->ViewAttributes() ?>><?php echo $jrf_tbl->strcompany->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strdepartment->Visible) { // strdepartment ?>
...
<div<?php echo $jrf_tbl->strloc->ViewAttributes() ?>><?php echo $jrf_tbl->strloc->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strposition->Visible) { // strposition ?>
		<td<?php echo $jrf_tbl->strposition->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strposition->ViewAttributes() ?>><?php echo $jrf_tbl->strposition->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strtelephone->Visible) { // strtelephone ?>
		<td<?php echo $jrf_tbl->strtelephone->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strtelephone->ViewAttributes() ?>><?php echo $jrf_tbl->strtelephone->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strcostcent->Visible) { // strcostcent ?>
		<td<?php echo $jrf_tbl->strcostcent->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strcostcent->ViewAttributes() ?>><?php echo $jrf_tbl->strcostcent->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strnature->Visible) { // strnature ?>
...
<div<?php echo $jrf_tbl->strdescript->ViewAttributes() ?>><?php echo $jrf_tbl->strdescript->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strattach->Visible) { // strattach ?>
		<td<?php echo $jrf_tbl->strattach->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strattach->ViewAttributes() ?>><?php echo $jrf_tbl->strattach->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strarea->Visible) { // strarea ?>
		<td<?php echo $jrf_tbl->strarea->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strarea->ViewAttributes() ?>><?php echo $jrf_tbl->strarea->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strpriority->Visible) { // strpriority ?>
...
<div<?php echo $jrf_tbl->strlastedit->ViewAttributes() ?>><?php echo $jrf_tbl->strlastedit->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strcategory->Visible) { // strcategory ?>
		<td<?php echo $jrf_tbl->strcategory->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strcategory->ViewAttributes() ?>><?php echo $jrf_tbl->strcategory->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strassigned->Visible) { // strassigned ?>
		<td<?php echo $jrf_tbl->strassigned->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strassigned->ViewAttributes() ?>><?php echo $jrf_tbl->strassigned->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strremarks->Visible) { // strremarks ?>
		<td<?php echo $jrf_tbl->strremarks->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strremarks->ViewAttributes() ?>><?php echo $jrf_tbl->strremarks->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strdatecomplete->Visible) { // strdatecomplete ?>
		<td<?php echo $jrf_tbl->strdatecomplete->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strdatecomplete->ViewAttributes() ?>><?php echo $jrf_tbl->strdatecomplete->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strifoverdue->Visible) { // strifoverdue ?>
		<td<?php echo $jrf_tbl->strifoverdue->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strifoverdue->ViewAttributes() ?>><?php echo $jrf_tbl->strifoverdue->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->strwithpr->Visible) { // strwithpr ?>
		<td<?php echo $jrf_tbl->strwithpr->CellAttributes() ?>>
<div<?php echo $jrf_tbl->strwithpr->ViewAttributes() ?>><?php echo $jrf_tbl->strwithpr->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($jrf_tbl->sap_num->Visible) { // sap_num ?>
		<td<?php echo $jrf_tbl->sap_num->CellAttributes() ?>>
<div<?php echo $jrf_tbl->sap_num->ViewAttributes() ?>><?php echo $jrf_tbl->sap_num->ListViewValue() ?></div>
</td>
	<?php } ?>
<?php
