...
<p><span class="phpmaker"><?php echo $Language->Phrase("Search") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $archv_finished->TableCaption() ?><br><br>
<a href="<?php echo $archv_finished->getReturnUrl() ?>"><?php echo $Language->Phrase("BackToList") ?></a></span></p>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
...
<input type="text" name="x_strdate" id="x_strdate" title="<?php echo $archv_finished->strdate->FldTitle() ?>" size="30" maxlength="50" value="<?php echo $archv_finished->strdate->EditValue ?>"<?php echo $archv_finished->strdate->EditAttributes() ?>>
	...
	<tr<?php echo $archv_finished->strtime->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strtime->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strtime" id="z_strtime" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strtime->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strtime" id="x_strtime" title="<?php echo $archv_finished->strtime->FldTitle() ?>" size="30" maxlength="20" value="<?php echo $archv_finished->strtime->EditValue ?>"<?php echo $archv_finished->strtime->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
...
<input type="text" name="x_strusereadd" id="x_strusereadd" title="<?php echo $archv_finished->strusereadd->FldTitle() ?>" size="30" maxlength="100" value="<?php echo $archv_finished->strusereadd->EditValue ?>"<?php echo $archv_finished->strusereadd->EditAttributes() ?>>
	...
	<tr<?php echo $archv_finished->strcompany->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strcompany->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strcompany" id="z_strcompany" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strcompany->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strcompany" id="x_strcompany" title="<?php echo $archv_finished->strcompany->FldTitle() ?>" size="30" maxlength="50" value="<?php echo $archv_finished->strcompany->EditValue ?>"<?php echo $archv_finished->strcompany->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
	<tr<?php echo $archv_finished->strdepartment->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strdepartment->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strdepartment" id="z_strdepartment" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strdepartment->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strdepartment" id="x_strdepartment" title="<?php echo $archv_finished->strdepartment->FldTitle() ?>" size="30" maxlength="100" value="<?php echo $archv_finished->strdepartment->EditValue ?>"<?php echo $archv_finished->strdepartment->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
	<tr<?php echo $archv_finished->strloc->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strloc->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strloc" id="z_strloc" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strloc->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strloc" id="x_strloc" title="<?php echo $archv_finished->strloc->FldTitle() ?>" size="30" maxlength="200" value="<?php echo $archv_finished->strloc->EditValue ?>"<?php echo $archv_finished->strloc->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
	<tr<?php echo $archv_finished->strposition->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strposition->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strposition" id="z_strposition" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strposition->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strposition" id="x_strposition" title="<?php echo $archv_finished->strposition->FldTitle() ?>" size="30" maxlength="150" value="<?php echo $archv_finished->strposition->EditValue ?>"<?php echo $archv_finished->strposition->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
	<tr<?php echo $archv_finished->strtelephone->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strtelephone->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strtelephone" id="z_strtelephone" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strtelephone->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strtelephone" id="x_strtelephone" title="<?php echo $archv_finished->strtelephone->FldTitle() ?>" size="30" maxlength="50" value="<?php echo $archv_finished->strtelephone->EditValue ?>"<?php echo $archv_finished->strtelephone->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
	<tr<?php echo $archv_finished->strcostcent->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strcostcent->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strcostcent" id="z_strcostcent" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strcostcent->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strcostcent" id="x_strcostcent" title="<?php echo $archv_finished->strcostcent->FldTitle() ?>" size="30" maxlength="100" value="<?php echo $archv_finished->strcostcent->EditValue ?>"<?php echo $archv_finished->strcostcent->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
...
<textarea name="x_strdescript" id="x_strdescript" title="<?php echo $archv_finished->strdescript->FldTitle() ?>" cols="35" rows="4"<?php echo $archv_finished->strdescript->EditAttributes() ?>><?php echo $archv_finished->strdescript->EditValue ?></textarea>
	...
	<tr<?php echo $archv_finished->strarea->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strarea->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strarea" id="z_strarea" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strarea->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strarea" id="x_strarea" title="<?php echo $archv_finished->strarea->FldTitle() ?>" size="30" maxlength="200" value="<?php echo $archv_finished->strarea->EditValue ?>"<?php echo $archv_finished->strarea->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
	<tr<?php echo $archv_finished->strattach->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strattach->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_strattach" id="z_strattach" value="LIKE"></span></td>
		<td<?php echo $archv_finished->strattach->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strattach" id="x_strattach" title="<?php echo $archv_finished->strattach->FldTitle() ?>" size="30" maxlength="100" value="<?php echo $archv_finished->strattach->EditValue ?>"<?php echo $archv_finished->strattach->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
...
<input type="text" name="x_strdatecomplete" id="x_strdatecomplete" title="<?php echo $archv_finished->strdatecomplete->FldTitle() ?>" size="30" maxlength="20" value="<?php echo $archv_finished->strdatecomplete->EditValue ?>"<?php echo $archv_finished->strdatecomplete->EditAttributes() ?>>
	...
	<tr<?php echo $archv_finished->strwithpr->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->strwithpr->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_strwithpr" id="x_strwithpr" title="<?php echo $archv_finished->strwithpr->FldTitle() ?>" size="30" maxlength="20" value="<?php echo $archv_finished->strwithpr->EditValue ?>"<?php echo $archv_finished->strwithpr->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
...
<textarea name="x_strremarks" id="x_strremarks" title="<?php echo $archv_finished->strremarks->FldTitle() ?>" cols="35" rows="4"<?php echo $archv_finished->strremarks->EditAttributes() ?>><?php echo $archv_finished->strremarks->EditValue ?></textarea>
	...
	<tr<?php echo $archv_finished->sap_num->RowAttributes ?>>
		...
		<td<?php echo $archv_finished->sap_num->CellAttributes() ?>><span class="ewSearchOpr"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_sap_num" id="z_sap_num" value="LIKE"></span></td>
		<td<?php echo $archv_finished->sap_num->CellAttributes() ?>>
			<div style="white-space: nowrap;">
				<span class="phpmaker" style="float: left;">
<input type="text" name="x_sap_num" id="x_sap_num" title="<?php echo $archv_finished->sap_num->FldTitle() ?>" size="30" maxlength="100" value="<?php echo $archv_finished->sap_num->EditValue ?>"<?php echo $archv_finished->sap_num->EditAttributes() ?>>
</span>
			</div>
		</td>
	</tr>
