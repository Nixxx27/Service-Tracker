...
//
// Table class for category_tbl
//
class ccategory_tbl {
	var $TableVar = 'category_tbl';
	...
	//
	function ccategory_tbl() {
		global $Language;

		// ID
		$this->ID = new cField('category_tbl', 'category_tbl', 'x_ID', 'ID', '`ID`', 3, -1, FALSE, '`ID`', FALSE);
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] =& $this->ID;

		// strcategory
		$this->strcategory = new cField('category_tbl', 'category_tbl', 'x_strcategory', 'strcategory', '`strcategory`', 200, -1, FALSE, '`strcategory`', FALSE);
		$this->fields['strcategory'] =& $this->strcategory;

		// strremarks
		$this->strremarks = new cField('category_tbl', 'category_tbl', 'x_strremarks', 'strremarks', '`strremarks`', 201, -1, FALSE, '`strremarks`', FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `category_tbl` ($names) VALUES ($values)";
	}
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `category_tbl` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("category_tblview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "category_tbladd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("category_tbledit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("category_tbladd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("category_tbldelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=category_tbl" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
