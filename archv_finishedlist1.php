...
<div class="row">
	<?php
    		...
    		?>
    		<div class="col-lg-12">
    			<h3><strong><i class="fa fa-wrench"></i> FINISHED JOBS <small>Archived</small> <span class="badge" title="Total Records">&nbsp;<?php echo $num_total; ?>&nbsp;</span></strong></h3>
    		</div>
    	</div>
    	<hr>
...
<?php if ($archv_finished->strdate->Visible) { // strdate ?>
		<td bgcolor='#449d44'>
<div<?php echo $archv_finished->strdate->ViewAttributes() ?>><?php echo $archv_finished->strdate->ListViewValue() . " " . $archv_finished->strtime->ListViewValue(); ?></div>
</td>
	<?php } ?>
<?php if ($archv_finished->strdatecomplete->Visible) { // strdatecomplete ?>
		<td bgcolor='#449d44'>
