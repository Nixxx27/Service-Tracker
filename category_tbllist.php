...
<a href="javascript:ew_ToggleSearchPanel(category_tbl_list);" style="text-decoration: none;"><img id="category_tbl_list_SearchImage" src="images/collapse.gif" alt="" width="10" height="10" border="0"></a><span class="phpmaker">&nbsp;<?php echo $Language->Phrase("Search") ?></span><br>
...
<table class="ewBasicSearch" style="margin-left:50px">
	<tr>
		<td><span class="phpmaker">
			<input type="text" class="searchbox"name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" size="20" value="<?php echo ew_HtmlEncode($category_tbl->getSessionBasicSearchKeyword()) ?>">
			<input type="Submit" name="Submit"  class="btn btn-primary btn-sm" id="Submit" value="Search">

			<img src="img/system/buttons/export_excel.png" title="Export to Excel" onclick="javascript:location.href='<?php echo $category_tbl_list->ExportExcelUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/csv.png" title="Export to CSV" onclick="javascript:location.href='<?php echo $category_tbl_list->ExportCsvUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/showall.png" title="Show All" onclick="javascript:location.href='<?php echo $category_tbl_list->PageUrl() ?>cmd=reset'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/advanced_search.png" title="Advanced Search" onclick="javascript:location.href='category_tblsrch.php'" class='onhover cursorpointer' height='40px' width='auto'>
...
<?php if ($category_tbl->strcategory->Visible) { // strcategory ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $category_tbl->SortUrl($category_tbl->strcategory) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"><?php echo "Category" ?></td><td style="width: 10px;"><?php if ($category_tbl->strcategory->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($category_tbl->strcategory->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($category_tbl->strremarks->Visible) { // strremarks ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $category_tbl->SortUrl($category_tbl->strremarks) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"><?php echo "Remarks" ?></td><td style="width: 10px;"><?php if ($category_tbl->strremarks->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($category_tbl->strremarks->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<?php //if ($category_tbl_list->lTotalRecs > 0) { ?>
<span class="phpmaker">
	<img src="img/system/buttons/category.png" title="Add New" onclick="javascript:location.href='<?php echo $category_tbl_list->AddUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>

<?php if ($category_tbl_list->lTotalRecs > 0) { ?>
<a href="" onclick="ew_SubmitSelected(document.fcategory_tbllist, '<?php echo $category_tbl_list->MultiDeleteUrl ?>');return false;"><img src="img/system/buttons/delete.png" title="Delete Record" class='onhover cursorpointer' height='40px' width='auto'></a>
<?php } ?>
</span>
<?php //} ?>
</div>
