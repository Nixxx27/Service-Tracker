...
<div class="row">
    		<div class="col-lg-12">
    			<h3><strong><i class="fa fa-book"></i> Logs <small>history</small></h3>
    		</div>
    	</div>
    	<hr>
<a href="javascript:ew_ToggleSearchPanel(logs_list);" style="text-decoration: none;"><img id="logs_list_SearchImage" src="images/collapse.gif" alt="" width="10" height="10" border="0"></a><span class="phpmaker">&nbsp;<?php echo $Language->Phrase("Search") ?></span><br>
...
<table class="ewBasicSearch" style="margin-left:50px">
	<tr>
		<td><span class="phpmaker">
			<input type="text" class="searchbox"  name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" size="20" value="<?php echo ew_HtmlEncode($logs->getSessionBasicSearchKeyword()) ?>">
			<input type="Submit" name="Submit"  class="btn btn-primary btn-sm" id="Submit" value="Search">

			<img src="img/system/buttons/export_excel.png" title="Export to Excel" onclick="javascript:location.href='<?php echo $logs_list->ExportExcelUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/csv.png" title="Export to CSV" onclick="javascript:location.href='<?php echo $logs_list->ExportCsvUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/showall.png" title="Show All" onclick="javascript:location.href='<?php echo $logs_list->PageUrl() ?>cmd=reset'" class='onhover cursorpointer' height='40px' width='auto'>
			<img src="img/system/buttons/advanced_search.png" title="Advanced Search" onclick="javascript:location.href='logssrch.php'" class='onhover cursorpointer' height='40px' width='auto'>
		</td>
...
<?php if ($logs->struname->Visible) { // struname ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $logs->SortUrl($logs->struname) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"> <?php echo "Username" ?></td><td style="width: 10px;"><?php if ($logs->struname->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($logs->struname->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($logs->strdate->Visible) { // strdate ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $logs->SortUrl($logs->strdate) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"><?php echo "Date & Time"?></td><td style="width: 10px;"><?php if ($logs->strdate->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($logs->strdate->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($logs->straction->Visible) { // straction ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $logs->SortUrl($logs->straction) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td align="center"><?php echo "Action" ?></td><td style="width: 10px;"><?php if ($logs->straction->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($logs->straction->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
