...
<div class="row">
    <div class="col-lg-12">
    	<h3><strong><i class="fa fa-wrench"></i> NATURE OF JOB <small>View Record</small></strong></h3>
    </div>
</div>
    	<hr>
...
<?php if ($nature_tbl->Export == "") { ?>
<img  class="onhover cursorpointer" onclick="javascript:location.href='<?php echo $nature_tbl_view->ListUrl ?>'" src="img/system/buttons/back.png"  title="Back to List" height="40px" width="40px">
...
<img src="img/system/buttons/edit1.png" title="Edit Record" onclick="javascript:location.href='<?php echo $nature_tbl_view->EditUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
<img src="img/system/buttons/nature of job.png" title="Add New" onclick="javascript:location.href='<?php echo $nature_tbl_view->AddUrl ?>'" class='onhover cursorpointer' height='35px' width='auto'>
<img src="img/system/buttons/delete.png" title="Delete Record" onclick="javascript:location.href='<?php echo $nature_tbl_view->DeleteUrl ?>'" class='onhover cursorpointer' height='40px' width='auto'>
